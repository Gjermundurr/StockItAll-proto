...
#   Close TCP connection and Exit program
def exit_app():
    s.close()
    quit()

#   Executes each time Add button is pressed
def button_add():
    ...
    #   Create list with Entry data and convert the data to bytes then send it to server
